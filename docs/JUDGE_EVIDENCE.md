...
| 10 | 규제상 허용되는 구조다 | 금융위 「투자일임의 적용 범위」(2015.6.17) 법령해석 대조 | `smoke/REGULATION.md` |
...
| 항목 | 현재 상태 |
|---|---|
| gold 의 독립적 사람 검증 | 핵심 코퍼스 189건 중 제3자 모델 패널 판정 12건(6%)뿐. **사람 라벨은 0건** — `smoke/human_validation/` 에 워크플로만 준비 |
